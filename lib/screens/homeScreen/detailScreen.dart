                      ...
                      Container(
                        ...
                        child:  Column(children: [
                          ...
                          Container(
                            ...
                            child:FlutterMap(
                            options: MapOptions(center: LatLng(bridgeList[i].KinhDo,bridgeList[i].ViDo), zoom: 14),
                            layers: [
                              TileLayerOptions(
                        ...
                        margin: EdgeInsets.only(bottom: 10),
                          child: Center(
                            child: Container(
                              width: 300,
                              decoration: BoxDecoration(
                                border: Border.all(color: Color(0xff38b000),width: 1.5),
                                borderRadius: BorderRadius.circular(8)
                              ),
                              child: ListTile(
                                leading: Icon(Icons.add, color: Color(0xff38b000),),
                                title: Text('THÊM KIỂM TRA/ SỬA CHỮA', style: TextStyle(fontSize: 16,color: Color(0xff38b000)),),
                              )
                            )
                            ),
                      )
